...
import java.text.ParseException;
 ...
 public class SunTimes{
    	...
    	public static void main(String[] args) throws ParseException {
			System.out.println(GetSunTime(5114,116.587099,35.414921 ));
		}
    	
        public static String GetSunTime(long day, Double longitude, Double latitude) throws ParseException
        {
